                    ...
                    <div className="user-info-pane-left float-right d-flex align-items-center">
                        ...
                        <div className="ml-4">
                            <div className="d-flex mb-1">
                                <p className="user-info-label-width">Register</p>
                                <p className="user-info-label-exp">2023.01.01</p>
                            ...
                            <div className="d-flex mb-1">
                                <p className="user-info-label-width">Address</p>
                                <p className="user-info-label-exp">{wallet}</p>
                            </div>
                            <div className="d-flex">
                                <p className="user-info-label-width">Balance</p>
