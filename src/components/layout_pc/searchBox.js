        ...
        return (
            <div className="search h-80 w-full">
                <div className="search_card">
                    <p className="tracking-in-expand-fwd font-bold search_card_text py-3">COAR NFT 마켓플레이스</p>
                    <p className="tracking-in-expand-fwd-bottom pb-16">다양한 NFT 경험을 해보세요</p>
                    <input className="rounded-full text text-search font-bold z-20" type="search" placeholder="NFT 이름으로 검색해보세요" />
