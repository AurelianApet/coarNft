                ...
                <div className="d-flex justify-content-center pt-5 pb-5 z-20">
                    <div className="w-49">
                        <div className="d-flex justify-content-end mb-2">
                            ...
                            <Link to={'/'} className="btn btn-default modal_button modal_button_close float-right">닫기</Link>
                        </div>
                        ...
                        <div className="modal fade" id="NFTSaleBuyModal" role="dialog">
                            <div className="modal-dialog modal-dialog-centered">
                                <div className="modal-content p-4 modal_backgroundColor pl-5 pr-5 pt-4">
                                    ...
                                    <button className="btn buyButton mt-4" data-dismiss="modal" onClick={() => buySelectedNFT()} >buy</button>
                                </div>
                            </div>
                        </div>
                    </div>
