                        ...
                        <div className="col-md-4 pt-lg-4 pl-0 pr-0">
                            <div className="d-flex justify-content-between pb-4 mb-4" style={{borderBottom : '1px solid lightgrey'}}>
                                ...
                                <div>
                                    ...
                                    <button type="button" className="btn btn-default modal_button modal_button_primary float-right" onClick={this.onSellUpdateNFT}>수정</button>
                                </div>
                            </div>
                            ...
                            <div className="pt-4">
                                ...
                                <div className="col-md-12">
                                    <div className="row pt-1 pb-1 modal_info_header">
                                        ...
                                        <div className="col-md-3 text-center font-weight-bold pl-0 pr-0 ">판매등록 시각</div>
                                    </div>
