        ...
        return (
            <div className="pt-4 pl-1 pr-1 mt-7">
                <div className="d-flex justify-content-around pb-3 mb-2 pl-3 pr-3 mt-3">
                    <button onClick={() => this.stopSaleNFT(this.state.dbID)} className="btn btn-default btn-mobile-default modal_button_primary float-right">중지</button>
                    <Link to={{ pathname: "/NFTSellListUpdate", nftInfo: this.state}} className="btn btn-default btn-mobile-default modal_Link_primary float-right">수정</Link>
                    <Link to={'/NFTSellList'} className="btn btn-default btn-mobile-default modal_button_close float-right">닫기</Link>
                </div>
                ...
                <div className="mt-4 mb-4">
                    ...
                    <div className="coloredTd w-100">
                        ...
                        <div className="w-25 pl-0 pr-0 text-center">나의 판매가격</div>
                    </div>
