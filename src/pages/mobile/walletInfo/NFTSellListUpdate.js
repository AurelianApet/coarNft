                ...
                <div className="pt-4 pl-1 pr-1">
                    <div className="d-flex justify-content-between pb-3  mb-3 mt-3" style={{borderBottom : '1px solid lightgrey'}}>
                        ...
                        <div className="d-flex">
                            <button type="button" className="btn btn-mobile-default modal_button_primary float-right mr-3" onClick={this.onSellRegisteNFT}>판매</button>
                            <Link to={'/NFTSellList'} className="btn btn-mobile-default modal_button_close float-right">닫기</Link>
                        </div>
                    </div>
                    ...
                    <div className="pt-4">
                        <p className="mb-2 font-weight-bold pl-2">판매가격 : &nbsp; 
                        {
                        ...
                        <input type="text" className="form-control form-control-sm form-control-input mb-2 font-size-13" placeholder={'판매하실 가격을 입력해주세요.'} value={this.state.salePrice} onChange={this.onSalePriceChange} onBlur={this.onhandleFloat} />
                        <p className="mb-2 mt-3 font-weight-bold pl-2">NFT 상세정보</p>
